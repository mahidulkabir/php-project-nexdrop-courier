      ...
      <div class="container-fluid">
        ...
        <div class="row g-4">
          <div class="col-md-6 col-lg-3">
            <a href="./pages/reports/all_parcels.php" class="text-decoration-none">
          ...
          <div class="col-md-6 col-lg-3">
            <a href="completed_parcels.php" class="text-decoration-none">
          ...
          <div class="col-md-6 col-lg-3">
            <a href="unsuccessful_parcels.php" class="text-decoration-none">
          ...
          <div class="col-md-6 col-lg-3">
            <a href="processing_parcels.php" class="text-decoration-none">
